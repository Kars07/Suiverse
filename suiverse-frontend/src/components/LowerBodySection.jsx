    ...
    <div>
      <div className="text-center text-black p-10 text-4xl">
        ...
        <img
          src={individual}
          alt="Individual"
          className="mx-auto content-center p-14 m-14 w-1/4 border-2 border-black-200 shadow-2xl bg-white-600 rounded-3xl hover:border-2 hover:border-blue-500"
        />
        ...
        <button className="text-blue-600 p-4 pl-20 pr-20 border-2 border-blue-600 rounded-full m-10 w-text-xl hover:bg-blue-600 hover:text-white">
          Learn More
        </button>
      </div>
    </div>
